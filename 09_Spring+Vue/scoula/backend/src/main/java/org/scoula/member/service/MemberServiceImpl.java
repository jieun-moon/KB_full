...
public class MemberServiceImpl implements MemberService {
    ...
    final MemberMapper mapper; //DB 접근을 위한 mapper
...
//    아바타 이미지를 저장하는 메소드
    ...
    public MemberDTO join(MemberJoinDTO dto) {
        ...
        //비밀번호 암호화
        member.setPassword(passwordEncoder.encode(member.getPassword())); //비밀번호 암호화 및 비밀번호 변경시 사용할 경우(matches와 사용)
...
//        암호화된 비밀번호 비교할 때는 matches 사용(equals 사용X)
