<script setup>
// reactive, ref는 반응형 데이터를 만들어준다(reative: 참조형 데이터, ref: 값형 데이터)
...
// state의 isNavShow값이 true라면 앞에 있는 class 세 개, false라면 뒤에 있는 클래스 두 개 사용
...
<template>
  <nav class="navbar navbar-expand-sm bg-primary navbar-dark">
    <div class="container-fluid">
      ...
      <!-- :를 붙으면 script로 가서 :를 찾기 => vue 문법 -->
      <!-- navbar-toggler 버튼을 누를때마다 show 클래스가 추가됐다가 삭제되는 걸 반복한다 -->
