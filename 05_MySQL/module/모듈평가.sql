...
SELECT * FROM city;
SELECT CountryCode, Percentage FROM countrylanguage WHERE CountryCode = 'CHE';
...
UPDATE 'Name' = 'GoodSite';

SELECT * FROM country Order by name desc;

SELECT name From city UPDATE uppercase;

SELECT * FROM city SELFJOIN ON city.id = city.countrycode as ic;

SELECT length(district) FROM city;

SELECT avg(population) FROM city;

SELECT Continent, GNP FROM country ORDER BY GNP ASC;

SELECT * FROM country; -- code
SELECT * FROM city; -- country code

SELECT city.name as tn, country.name as cn FROM city
INNER JOIN on city.countryCode = country.Code;

SELECT Name FROM country;
SELECT * FROM countrylanguage;

-- SELECT Language FROM city
-- OUTER JOIN on city.countryCode = countrylanguage.CountryCode

SELECT Name FROM city GROUP BY Population(SELECT MAX(Population) FROM city);